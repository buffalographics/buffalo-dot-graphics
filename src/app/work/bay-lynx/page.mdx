import logo from '@/images/bay-lynx-logo-color-black.svg'
import imageHero from './hero.webp'

export const caseStudy = {
  client: 'Bay-Lynx',
  title: 'Bay-Lynx Manufacturing Inc.',
  description:
    'Bay-Lynx is a family-owned business that manufactures volumetric concrete mixers, material spreaders and structural beam cambering machines.',
  summary: [
    'Bay-Lynx Manufacturing Inc.',
    `We applied vehicle graphics for the new Titan Volumetric Mixer unvelied at World of Concrete`,
  ],
  logo,
  image: { src: imageHero },
  date: '2022-01',
